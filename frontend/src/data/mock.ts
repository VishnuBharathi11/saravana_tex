...
export const notifications: AppNotification[] = [
  {
    ...
    description: "Quotation follow-up with Vetri Steels at 11:30",
    timestamp: "10m ago",
    targetId: followUps[0]?.id ?? "fu-1",
    read: false,
  },
  {
    id: "N2",
    ...
    description: "Payment reminder for Salem Pipes was not completed",
    timestamp: "1h ago",
    targetId: followUps[1]?.id ?? "fu-2",
    read: false,
  },
  {
    id: "N3",
    ...
    description: "Kongu Spinners enquiry for 240 Bags Cotton cone",
    timestamp: "3h ago",
    targetId: leads[0]?.id ?? "lead-1",
    read: false,
  },
  {
    id: "N4",
    ...
    description: "ST/26-27/1042 moved to Processing",
    timestamp: "Yesterday",
  ...
  },
  {
    ...
    description: "Site meeting with Amman Industries tomorrow 09:00",
    timestamp: "Yesterday",
    targetId: followUps[2]?.id ?? "fu-3",
    read: true,
  },
];
